            ...
            <section id="orders" >
               <div class="container">
                  <div class="row"> 
					 ...
					 <div class="col-sm-8 text-center" ng-controller="addressController" ng-cloak>   
                         <div class="panel">
						 <div class="panel-body">
						     <div id="tableToExport" class="products-table table-responsive"  >
                                          <table class="table" class="table table-striped" id="exportthis" >
                                             ...
                                             <tbody >
                                                <tr  ng-repeat="values in address.data.data  "> 
                                                   ...
                                                   <td>@{{values.created_at_formatted}}</td>
                                                    <td class="actions">
                                                      <a class="btn btn-xs edit-product" href="#" ><i class="fa fa-edit"></i></a> 
...
<script type="text/javascript" src="{{ URL::asset('web-food/angular-controllers/address.js')}}"></script> 
@endsection